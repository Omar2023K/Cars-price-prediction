...
def Analysis():
    ...
    st.image("car_2.jpg", use_container_width=True)
...
def prediction():
    ...
    if bt == True:
        ...
        target = joblib.load('target_scaler (1).pkl')
        ...
        data_input = np.array([[year_filter,km_driven,engine,max_power,Torque,transmission_encoded,owner_encoded]])
